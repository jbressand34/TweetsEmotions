...
public class Word2VecDemo {
    ...
    private String inputFilePath = "the-file-name.txt";
    private String modelFilePath = "GoogleNews-vectors-negative300.bin";
    ...
    public  void train() throws IOException {
        ...
        WordVectorSerializer.writeWordVectors(vec, "GoogleNews-vectors-negative300.bin");
    }
}
